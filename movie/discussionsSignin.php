...
{
	echo 'You are already signed in, you can <a href="discussionsSignout.php">sign out</a> if you want.';
}
else
{
		...
		else
		{
			...
			else
			{
				...
				else
				{
					...
					echo 'Welcome, ' . $_SESSION['user_name'] . '. <br /><a href="discussions.php">Proceed to the forum overview</a>.';
				}
			}
		}
	}
