...
}(document, 'script', 'facebook-jssdk'));</script></p></p>
...
echo $name . '<br/>'. $date . '<br/>' . '<br/>' . $comment . '<br/>' . '<br/>' . '<hr size="1"/>'
;}
?> 
    </div>
    </div>
