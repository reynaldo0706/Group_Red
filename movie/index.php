              ...
              <table border="0" cellspacing="0" cellpadding="2">
                <tr>
                  ...
                  <td valign="top"><?php
					  ...
					  $myCalendar->setYearInterval(1970, 2040); //$myCalendar->setYearInterval(1970, 2020);
					  ...
					  ?></td>
                  <td valign="top"><ul>
                    <li> Set default date to server day and month, with year 2040(Auto unset if date is disabled)</li>
